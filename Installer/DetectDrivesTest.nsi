...
Function DriveTestCallbackFunction
	IfFileExists "$R0gamedatadir.txt" FoundFile Continue
	FoundFile:
	  MessageBox "MB_OK" "Found it on Drive $R0"
	  Push "Stop"
	  goto End
	  
	Continue:
	  MessageBox "MB_OK" "Not found on Drive $R0"
	  Push "continue"
	End:
...
Function DDTest
	Push "Hard Drives CDROM Drives RAM Drives Network Drives" 
	Push $0 
	GetFunctionAddress $0 "DriveTestCallbackFunction"
	Exch $0 
	Call DetectDrives
FunctionEnd ; DDTest
