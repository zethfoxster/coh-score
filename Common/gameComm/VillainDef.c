...
static void villainDefReload(const char* relpath, int when)
{
	...
	if (ParserReloadFile(relpath, 0, ParseVillainDefBegin, sizeof(VillainDefList), cpp_const_cast(VillainDefList*)(&villainDefList), NULL, NULL, NULL, NULL))
	{
...
{
	// look for a nictus hunter in given villain group
