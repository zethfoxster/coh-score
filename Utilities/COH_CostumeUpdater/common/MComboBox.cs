    ...
    public class MComboBox : ComboBox
    {
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            else
            {
                ...
                if (this.Items[e.Index].GetType() == typeof(MComboBoxItem))
                {

                    // get item to draw
                    MComboBoxItem item = (MComboBoxItem) this.Items[e.Index];
                    ...
                    if (item.ImageIndex != -1)
                    {
                        ...
                        this.ImageList.Draw(e.Graphics, e.Bounds.Left, e.Bounds.Top + 2,
                            imgs.ImageSize.Width, imgs.ImageSize.Height - 4, item.ImageIndex);
