/** @file main.cpp
    @brief Substance Tutorial, platform D3D10pc (D3D textures output), DDS output
...
#include "../common/d3d10pc_framework.h"
#include <d3dx10.h>
...
int main(int argc,char** argv)			
{
	...
	d3ddevice = d3d10pcFrameworkInitD3D(hWnd);
	if ( d3ddevice == NULL )
	{
		assert(0);
