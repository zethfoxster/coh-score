...
namespace FX_TreeParser
{
    public partial class FX_TreeParser : Form
    {
        ...
        public FX_TreeParser(string filePath)
        {
            ...
            iml.Images.Add(Properties.Resources.FXIcon);
            iml.Images.Add(Properties.Resources.PARTIcon);
            iml.Images.Add(Properties.Resources.BHVRIcon);
            iml.Images.Add(Properties.Resources.TGAIcon);
            iml.Images.Add(Properties.Resources.GEOIcon);
