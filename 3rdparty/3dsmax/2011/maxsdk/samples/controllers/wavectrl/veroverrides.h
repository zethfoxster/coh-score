...
#define MAXVER_INTERNALNAME "wavectrl\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "wavectrl.dlc\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Waveform controller (plugin)\0"//should  be overidden on a per-dll level
