...
#define MAXVER_INTERNALNAME "auctrl\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "auctrl.dlc\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Audio amplitude controller (plugin)\0"//should  be overidden on a per-dll level
