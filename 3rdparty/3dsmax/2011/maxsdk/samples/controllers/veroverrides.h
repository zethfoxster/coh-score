...
#define MAXVER_INTERNALNAME "ctrl\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "ctrl.dlc\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Standard controllers (plugin)\0"//should  be overidden on a per-dll level
