...
#define MAXVER_INTERNALNAME "reactor\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "reactor.dlc\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Change-reaction controller (plugin)\0"//should  be overidden on a per-dll level
