...
#define MAXVER_INTERNALNAME "spring\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "spring.dlc\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Mass - spring controller (plugin)\0"//should  be overidden on a per-dll level
