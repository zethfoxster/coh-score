...
#define MAXVER_INTERNALNAME "SimpleFaceDataChannels\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "SimpleFaceData.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Simple per-face data channel sample (plugin)\0"//should  be overidden on a per-dll level
