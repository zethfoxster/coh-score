...
#define MAXVER_INTERNALNAME "Mb_Select\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Mb_Select.gup\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "A plugin loader for MetalBump\0"//should  be overidden on a per-dll level
