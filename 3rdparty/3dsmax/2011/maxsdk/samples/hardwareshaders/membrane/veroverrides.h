...
#define MAXVER_INTERNALNAME "ViewportManager\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "ViewportManager.gup\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Manager for loading Viewport Effects\0"//should  be overidden on a per-dll level
