...
#define MAXVER_INTERNALNAME "Cubemap\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Cubemap.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "A Cubemap vertexshader\0"//should  be overidden on a per-dll level
