...
#define MAXVER_INTERNALNAME "MetalBump9\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "MetalBump9.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Metal Bump Viewport Effect DX9\0"//should  be overidden on a per-dll level
