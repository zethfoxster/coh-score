...
#define MAXVER_INTERNALNAME "LightMap\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "LightMap.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "A light map for texture baking\0"//should  be overidden on a per-dll level
