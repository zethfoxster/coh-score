...
#define MAXVER_INTERNALNAME "HSUtil\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "HSUtil.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Hardware Shader Utilities (plugin)\0"//should  be overidden on a per-dll level
