...
#define MAXVER_INTERNALNAME "prim\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "prim.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Standard primitive objects (plugin)\0"//should  be overidden on a per-dll level
