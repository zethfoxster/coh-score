...
#define MAXVER_INTERNALNAME "omesher\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "omesher.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Dynamic Object Mesher\0"//should  be overidden on a per-dll level
