...
#define MAXVER_INTERNALNAME "helpers\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "helpers.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Standard helper objects (plugin)\0"//should  be overidden on a per-dll level
