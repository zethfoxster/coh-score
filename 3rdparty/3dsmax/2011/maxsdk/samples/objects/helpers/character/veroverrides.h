...
#define MAXVER_INTERNALNAME "LuminaireHlpObj\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "LuminaireHlpObj.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Luminaire helper object (plugin)\0"//should  be overidden on a per-dll level
