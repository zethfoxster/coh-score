...
#define MAXVER_INTERNALNAME "scs\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "scs.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Extended primitive objects (plugin)\0"//should  be overidden on a per-dll level
