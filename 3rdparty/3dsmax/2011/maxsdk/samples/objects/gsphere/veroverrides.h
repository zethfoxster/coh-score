...
#define MAXVER_INTERNALNAME "gsphere\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "gsphere.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Geodesic sphere object (plugin)\0"//should  be overidden on a per-dll level
