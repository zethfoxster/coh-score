...
#define MAXVER_INTERNALNAME "BlobMesh\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "BlobMesh.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Blob Mesh\0"//should  be overidden on a per-dll level
