...
#define MAXVER_INTERNALNAME "suprprts\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "suprprts.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Super particles object (plugin)\0"//should  be overidden on a per-dll level
