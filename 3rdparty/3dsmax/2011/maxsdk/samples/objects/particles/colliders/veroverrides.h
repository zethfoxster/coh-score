...
#define MAXVER_INTERNALNAME "Colliders\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Colliders.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "collider\0"//should  be overidden on a per-dll level
