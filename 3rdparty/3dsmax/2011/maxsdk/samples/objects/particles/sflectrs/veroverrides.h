...
#define MAXVER_INTERNALNAME "sflectrs\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "sflectrs.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Enhanced deflectors (plugin)\0"//should  be overidden on a per-dll level
