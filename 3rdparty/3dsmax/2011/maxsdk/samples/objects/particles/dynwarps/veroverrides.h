...
#define MAXVER_INTERNALNAME "dynwarps\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "dynwarps.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Dynamic spacewarps (plugin)\0"//should  be overidden on a per-dll level
