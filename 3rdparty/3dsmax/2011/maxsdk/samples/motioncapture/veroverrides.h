...
#define MAXVER_INTERNALNAME "motion\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "motion.dlc\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Motion capture controller (plugin)\0"//should  be overidden on a per-dll level
