...
#define MAXVER_INTERNALNAME "mckbddev\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "mckbddev.dlc\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Keyboard controller for motion capture (plugin)\0"//should  be overidden on a per-dll level
