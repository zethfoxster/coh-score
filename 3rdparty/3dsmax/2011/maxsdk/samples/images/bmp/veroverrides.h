...
#define MAXVER_INTERNALNAME "bmp\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "bmp.bmi\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "BMP file I/O (plugin)\0"//should  be overidden on a per-dll level
