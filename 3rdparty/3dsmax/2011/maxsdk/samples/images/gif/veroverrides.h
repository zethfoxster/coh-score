...
#define MAXVER_INTERNALNAME "gif\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "gif.bmi\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "GIF file I/O (plugin)\0"//should  be overidden on a per-dll level
