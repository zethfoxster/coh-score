...
#define MAXVER_INTERNALNAME "epsres\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "epsres.dll\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Resource library for eps.bmi\0"//should  be overidden on a per-dll level
