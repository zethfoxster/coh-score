...
#define MAXVER_INTERNALNAME "ifl\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "ifl.bmi\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "IFL file I/O (plugin)\0"//should  be overidden on a per-dll level
