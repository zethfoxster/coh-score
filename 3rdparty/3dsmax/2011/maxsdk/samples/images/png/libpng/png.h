...
// SR NOTE64: Limit to 32-bit address space (that's still a 4GB PNG file!)
inline png_voidp png_malloc(png_structp png_ptr, png_size_t size)
{
   return png_malloc(png_ptr, static_cast<png_uint_32>(size));	// SR DCAST64: Downcast to 4G limit.
}
