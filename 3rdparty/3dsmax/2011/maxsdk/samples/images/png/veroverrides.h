...
#define MAXVER_INTERNALNAME "png\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "png.bmi\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "PNG file I/O (plugin)\0"//should  be overidden on a per-dll level
