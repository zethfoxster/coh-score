...
/* end SGI tags */
	...
	{ TIFFTAG_MODELPIXELSCALE, 3, 3, TIFF_DOUBLE, FIELD_MODELPIXELSCALE,
	TRUE, FALSE, "ModelPixelScale" },
#endif
...
#ifdef GEOREFSYS_UVW_MAPPING 
	{ TIFFTAG_GEOKEYDIR,	-1, -1, TIFF_SHORT, FIELD_GEOKEYDIR, 
	TRUE, FALSE, "GeoKeyDirectory" },
	{ TIFFTAG_GEODOUBLE,	-1, -1, TIFF_DOUBLE, FIELD_GEODOUBLE, 
	TRUE, FALSE, "GeoDoubleParams" },
	{ TIFFTAG_GEOASCII,		-1, -1, TIFF_ASCII, FIELD_GEOASCII, 
