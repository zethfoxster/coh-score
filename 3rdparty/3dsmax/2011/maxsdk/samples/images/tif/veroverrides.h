...
#define MAXVER_INTERNALNAME "tif\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "tif.bmi\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "TIF file I/O (plugin)\0"//should  be overidden on a per-dll level
