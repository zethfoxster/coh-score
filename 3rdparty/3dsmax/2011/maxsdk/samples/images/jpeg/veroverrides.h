...
#define MAXVER_INTERNALNAME "jpeg\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "jpeg.bmi\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "JPEG file I/O (plugin)\0"//should  be overidden on a per-dll level
