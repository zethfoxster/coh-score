...
#define MAXVER_INTERNALNAME "targa\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "targa.bmi\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Targa file I/O (plugin)\0"//should  be overidden on a per-dll level
