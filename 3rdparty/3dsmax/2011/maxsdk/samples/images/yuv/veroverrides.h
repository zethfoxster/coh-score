...
#define MAXVER_INTERNALNAME "yuv\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "yuv.bmi\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "YUV file I/O (plugin)\0"//should  be overidden on a per-dll level
