...
#define MAXVER_INTERNALNAME "rla\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "rla.bmi\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "RLA file I/O (plugin)\0"//should  be overidden on a per-dll level
