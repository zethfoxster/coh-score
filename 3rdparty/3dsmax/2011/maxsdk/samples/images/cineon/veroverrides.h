...
#define MAXVER_INTERNALNAME "CIN\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "CIN.bmi\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Cineon I/O (plugin)\0"//should  be overidden on a per-dll level
