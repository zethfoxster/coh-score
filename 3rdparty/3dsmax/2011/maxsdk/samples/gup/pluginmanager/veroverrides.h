...
#define MAXVER_INTERNALNAME "PluginManager\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "PluginManager.gup\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Plug-in Manager\0"//should  be overidden on a per-dll level
