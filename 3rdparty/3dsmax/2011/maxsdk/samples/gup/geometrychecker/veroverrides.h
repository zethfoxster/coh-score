...
#define MAXVER_INTERNALNAME "GeometryChecker\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "GeometryChecker.gup\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Geometry Checker GUP\0"//should  be overidden on a per-dll level
