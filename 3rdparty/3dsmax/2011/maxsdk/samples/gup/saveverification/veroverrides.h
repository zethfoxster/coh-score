...
#define MAXVER_INTERNALNAME "SaveVerification\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "SaveVerification.gup\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Plugin to verify that a saved file is a valid OLE structured storage file.\0"//should  be overidden on a per-dll level
