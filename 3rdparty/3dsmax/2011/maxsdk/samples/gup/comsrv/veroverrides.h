...
#define MAXVER_ORIGINALFILENAME "comsrv.gup\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "3ds max COM/DCOM Server (GUP Plugin)\0"//should  be overidden on a per-dll level
