...
#define MAXVER_INTERNALNAME "MaxClient\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "MaxClient.exe\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MaxClient - A Client Sample to 3D Studio MAX COM/DCOM Server\0"//should  be overidden on a per-dll level
