...
#define MAXVER_INTERNALNAME "EPoly\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "EPoly.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Editable Polygon Mesh\0"//should  be overidden on a per-dll level
