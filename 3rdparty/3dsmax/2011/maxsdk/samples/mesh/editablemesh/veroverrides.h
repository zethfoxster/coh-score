...
#define MAXVER_INTERNALNAME "update1\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "update1.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Base mesh object (plugin)\0"//should  be overidden on a per-dll level
