...
{
public:
	EditPolyModPolyOperationGrip():mpEditPoly(NULL),mpPolyOperation(NULL){};
	virtual ~EditPolyModPolyOperationGrip(){};
    virtual void Init(EditPolyMod *editPoly,PolyOperation *polyOperation){mpEditPoly = editPoly; mpPolyOperation = polyOperation;}
	EditPolyMod*  GetEditPolyMod() { return mpEditPoly; }
	void SetEditPolyMod( EditPolyMod* pEdPolyMod ){ mpEditPoly = pEdPolyMod; }
	PolyOperation*  GetPolyOperation() { return mpPolyOperation; }
	void SetPolyOperation( PolyOperation* pPolyOperation){ mpPolyOperation = pPolyOperation; }
...
public:
	...
	HingeGrip():mEdgePicked(""),mPickIcon(""),i(0){};
...
public:
	...
	WeldEdgesGrip::WeldEdgesGrip():mStrBefore("     "),mStrAfter("     "){}
