...
#define MAXVER_INTERNALNAME "Manip\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Manip.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Standard Manipulators (plugin)\0"//should  be overidden on a per-dll level
