...
#define MAXVER_INTERNALNAME "iflmgr\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "iflmgr.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "IFL file management utility (plugin)\0"//should  be overidden on a per-dll level
