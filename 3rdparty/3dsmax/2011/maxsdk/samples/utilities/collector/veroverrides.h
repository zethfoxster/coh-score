...
#define MAXVER_INTERNALNAME "Collector\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Collector.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Resource collector (plugin)\0"//should  be overidden on a per-dll level
