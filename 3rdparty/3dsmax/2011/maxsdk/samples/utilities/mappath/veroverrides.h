...
#define MAXVER_INTERNALNAME "MapPath\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "MapPath.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Bitmap path editing utility (plugin)\0"//should  be overidden on a per-dll level
