...
#define MAXVER_INTERNALNAME "PolygonCount\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "PolygonCount.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Polygon Count Utility\0"//should  be overidden on a per-dll level
