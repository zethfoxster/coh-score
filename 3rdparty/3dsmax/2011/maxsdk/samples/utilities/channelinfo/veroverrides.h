...
#define MAXVER_INTERNALNAME "ChannelInfo\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "ChanInfo.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Channel Info Untility\0"//should  be overidden on a per-dll level
