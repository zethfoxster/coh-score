...
#define MAXVER_INTERNALNAME "nutil\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "nutil.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "NURBS surface approximation utility (plugin)\0"//should  be overidden on a per-dll level
