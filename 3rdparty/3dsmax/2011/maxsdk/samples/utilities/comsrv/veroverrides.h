...
#define MAXVER_INTERNALNAME "comsrv\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "comsrv.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "COM/DCOM Server Control Utility (plugin)\0"//should  be overidden on a per-dll level
