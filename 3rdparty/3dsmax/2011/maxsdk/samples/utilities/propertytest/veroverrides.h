...
#define MAXVER_INTERNALNAME "PropertyTest\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "PropertyTest.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "PropertySet Test Pug-In\0"//should  be overidden on a per-dll level
