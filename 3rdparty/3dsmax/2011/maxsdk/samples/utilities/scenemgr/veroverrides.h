...
#define MAXVER_INTERNALNAME "SceneMgr\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "SceneMgr.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Scene manager (plugin)\0"//should  be overidden on a per-dll level
