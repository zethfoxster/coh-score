...
#define MAXVER_INTERNALNAME "UMaxFind\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "UMaxFind.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "File Finder Utility (plugin)\0"//should  be overidden on a per-dll level
