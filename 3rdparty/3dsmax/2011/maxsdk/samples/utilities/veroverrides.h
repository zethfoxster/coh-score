...
#define MAXVER_INTERNALNAME "utility\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "utility.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Standard utilities (plugin)\0"//should  be overidden on a per-dll level
