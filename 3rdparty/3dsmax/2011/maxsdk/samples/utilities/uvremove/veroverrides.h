...
#define MAXVER_INTERNALNAME "UVRemove\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "UVRemove.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "UVW coordinate remover (plugin)\0"//should  be overidden on a per-dll level
