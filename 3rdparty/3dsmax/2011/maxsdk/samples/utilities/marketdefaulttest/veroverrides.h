...
#define MAXVER_INTERNALNAME "marketDefaultTest\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "marketDefaultTest.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Unit Test for Market Default Feature\0"//should  be overidden on a per-dll level
