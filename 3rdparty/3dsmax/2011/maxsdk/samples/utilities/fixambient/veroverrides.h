...
#define MAXVER_INTERNALNAME "fixambient\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "fixambient.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Ambient/Diffuse Color Consistency\0"//should  be overidden on a per-dll level
