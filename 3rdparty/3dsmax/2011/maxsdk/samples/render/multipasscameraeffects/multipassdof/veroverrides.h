...
#define MAXVER_INTERNALNAME "multiPassDOF\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "multiPassDOF.dlv\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MultiPass DOF Camera Effect (plugin)\0"//should  be overidden on a per-dll level
