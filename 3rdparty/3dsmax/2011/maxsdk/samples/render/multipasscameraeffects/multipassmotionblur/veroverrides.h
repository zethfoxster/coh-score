...
#define MAXVER_INTERNALNAME "multiPassMotionBlur\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "multiPassMotionBlur.dlv\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MultiPass Motion Blur Camera Effect (plugin)\0"//should  be overidden on a per-dll level
