...
#define MAXVER_INTERNALNAME "pseudoMap\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "pseudoMap.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Pseudo Color Exposure Control\0"//should  be overidden on a per-dll level
