...
#define MAXVER_INTERNALNAME "RenderUtil\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "RenderUtil.dll\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Render Utilities\0"//should  be overidden on a per-dll level
