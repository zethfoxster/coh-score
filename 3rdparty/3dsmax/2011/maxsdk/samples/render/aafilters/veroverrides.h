...
#define MAXVER_INTERNALNAME "kernel\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "kernel.dlk\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "PreFilter kernels (plugin)\0"//should  be overidden on a per-dll level
