...
#define MAXVER_INTERNALNAME "brightCon\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "brightCon.dlv\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Brightness & Contrast Effect (plugin)\0"//should  be overidden on a per-dll level
