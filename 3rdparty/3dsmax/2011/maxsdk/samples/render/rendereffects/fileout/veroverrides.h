...
#define MAXVER_INTERNALNAME "fileOut\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "fileOut.dlv\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "File Output Effect (plugin)\0"//should  be overidden on a per-dll level
