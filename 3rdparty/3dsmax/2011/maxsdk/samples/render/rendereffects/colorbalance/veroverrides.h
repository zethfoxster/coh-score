...
#define MAXVER_INTERNALNAME "colorBalance\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "colorBalance.dlv\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Color Balance Effect (plugin)\0"//should  be overidden on a per-dll level
