...
#define MAXVER_INTERNALNAME "blur\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "blur.dlv\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Blur Effect (plugin)\0"//should  be overidden on a per-dll level
