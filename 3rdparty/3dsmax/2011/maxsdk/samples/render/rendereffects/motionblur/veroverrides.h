...
#define MAXVER_INTERNALNAME "motionBlur\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "motionBlur.dlv\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Motion Blur Effect (plugin)\0"//should  be overidden on a per-dll level
