...
#define MAXVER_INTERNALNAME "rendvue\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "rendvue.dlr\0"//should  be overidden on a per-dll level
