...
#define MAXVER_INTERNALNAME "samplers\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "samplers.dlh\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Samplers (plugin)\0"//should  be overidden on a per-dll level
