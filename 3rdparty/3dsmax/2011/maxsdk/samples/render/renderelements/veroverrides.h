...
#define MAXVER_INTERNALNAME "renElem\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "renElem.dln\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "RenderElements (plugin)\0"//should  be overidden on a per-dll level
