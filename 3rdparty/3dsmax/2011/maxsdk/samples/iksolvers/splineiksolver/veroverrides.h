...
#define MAXVER_INTERNALNAME "SplineIKSolver\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "SplineIKSolver.dlc\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "A new IK Solver\0"//should  be overidden on a per-dll level
