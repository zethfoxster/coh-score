...
#define MAXVER_INTERNALNAME "IKLimb\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "IKLimb.dlc\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "IK Limb (IK Plugin)\0"//should  be overidden on a per-dll level
