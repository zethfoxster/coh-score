...
#define MAXVER_INTERNALNAME "vrblout\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "vrblout.dle\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "VRML/VRBL .WRL file export module (core plugin)\0"//should  be overidden on a per-dll level
