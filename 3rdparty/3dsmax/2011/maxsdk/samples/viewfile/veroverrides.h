...
#define MAXVER_INTERNALNAME "viewfile\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "viewfile.dll\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "File viewer support\0"//should  be overidden on a per-dll level
