...
#define MAXVER_INTERNALNAME "crosfade\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "crosfade.flt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Cross-fade transition (plugin)\0"//should  be overidden on a per-dll level
