...
#define MAXVER_INTERNALNAME "contrast\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "contrast.flt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Contrast image filter (plugin)\0"//should  be overidden on a per-dll level
