...
#define MAXVER_INTERNALNAME "alpha\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "alpha.flt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Alpha compositor (plugin)\0"//should  be overidden on a per-dll level
