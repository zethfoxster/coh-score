...
#define MAXVER_INTERNALNAME "negative\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "negative.flt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Negative image filter (plugin)\0"//should  be overidden on a per-dll level
