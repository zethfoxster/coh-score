...
#define MAXVER_INTERNALNAME "pdalpha\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "pdalpha.flt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Pseudo-alpha image filter (plugin)\0"//should  be overidden on a per-dll level
