...
#define MAXVER_INTERNALNAME "add\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "add.flt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Additive compositor (plugin)\0"//should  be overidden on a per-dll level
