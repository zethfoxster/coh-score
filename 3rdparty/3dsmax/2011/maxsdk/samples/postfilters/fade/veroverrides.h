...
#define MAXVER_INTERNALNAME "fade\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "fade.flt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Fade image filter (plugin)\0"//should  be overidden on a per-dll level
