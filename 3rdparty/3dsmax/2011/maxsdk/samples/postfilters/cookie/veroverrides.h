...
#define MAXVER_INTERNALNAME "imgalpha\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "imgalpha.flt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Cookie cutter image filter (plugin)\0"//should  be overidden on a per-dll level
