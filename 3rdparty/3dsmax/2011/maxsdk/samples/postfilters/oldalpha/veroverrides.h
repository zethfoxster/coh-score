...
#define MAXVER_INTERNALNAME "oldalpha\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "oldalpha.flt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Old alpha compositor (plugin)\0"//should  be overidden on a per-dll level
