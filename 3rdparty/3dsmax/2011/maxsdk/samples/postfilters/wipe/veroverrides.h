...
#define MAXVER_INTERNALNAME "wipe\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "wipe.flt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Wipe transition (plugin)\0"//should  be overidden on a per-dll level
