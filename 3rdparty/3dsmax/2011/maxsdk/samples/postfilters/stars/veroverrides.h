...
#define MAXVER_INTERNALNAME "stars\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "stars.flt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Stars image filter (plugin)\0"//should  be overidden on a per-dll level
