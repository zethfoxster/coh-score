...
#define MAXVER_INTERNALNAME "vrmlexp\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "vrmlexp.dle\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "VRML 2.0 .WRL file export (core plugin)\0"//should  be overidden on a per-dll level
