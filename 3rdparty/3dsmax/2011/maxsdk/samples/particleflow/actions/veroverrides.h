...
#define MAXVER_INTERNALNAME "PFElements\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "PFElements.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "PF Elements\0"//should  be overidden on a per-dll level
