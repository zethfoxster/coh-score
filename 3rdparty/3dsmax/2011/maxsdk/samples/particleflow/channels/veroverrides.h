...
#define MAXVER_INTERNALNAME "PFChannels\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "PFChannels.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "PF Channels\0"//should  be overidden on a per-dll level
