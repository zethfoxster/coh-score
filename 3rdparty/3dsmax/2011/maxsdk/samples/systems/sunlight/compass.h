...
class CompassRoseObject: public HelperObject {
	public:			
		...
		void InitNodeName(TSTR& s) { s = MaxSDK::GetResourceString(IDS_DB_COMPASS); }
		...
		void GetClassName(TSTR& s) { s = TSTR(MaxSDK::GetResourceString(IDS_DB_COMPASS_CLASS)); }
	...
	private:
		CompassRoseObjCreateCallBack mCompassRoseCreateCB;
	};				
