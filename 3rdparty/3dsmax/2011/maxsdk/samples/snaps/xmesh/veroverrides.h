...
#define MAXVER_INTERNALNAME "x_mesh\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "x_mesh.dls\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Mesh object snap (plugin)\0"//should  be overidden on a per-dll level
