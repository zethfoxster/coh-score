...
#define MAXVER_INTERNALNAME "grid\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "grid.dls\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Grid snap (plugin)\0"//should  be overidden on a per-dll level
