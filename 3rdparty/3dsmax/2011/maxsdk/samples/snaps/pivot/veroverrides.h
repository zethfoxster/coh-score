...
#define MAXVER_INTERNALNAME "pivot\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "pivot.dls\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Pivot snap (plugin)\0"//should  be overidden on a per-dll level
