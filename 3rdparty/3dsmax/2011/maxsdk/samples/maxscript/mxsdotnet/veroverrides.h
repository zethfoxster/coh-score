...
#define MAXVER_INTERNALNAME "mxsDotNet\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "mxsdotNet.dlx\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MXS dotNet plugin\0"//should  be overidden on a per-dll level
