...
#define MAXVER_INTERNALNAME "mods\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "mods.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Standard modifiers (plugin)\0"//should  be overidden on a per-dll level
