...
#define MAXVER_INTERNALNAME "PatchSel\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "PatchSel.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Patch Select Modifier\0"//should  be overidden on a per-dll level
