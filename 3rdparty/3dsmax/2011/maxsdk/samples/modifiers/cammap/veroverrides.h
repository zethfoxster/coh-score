...
#define MAXVER_INTERNALNAME "cammap\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "cammap.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Camera mapping modifier and world space modifier (plugin)\0"//should  be overidden on a per-dll level
