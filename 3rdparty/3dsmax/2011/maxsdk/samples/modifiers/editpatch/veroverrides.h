...
#define MAXVER_INTERNALNAME "EditPatch\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "EditPatch.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Edit Patch (plugin)\0"//should  be overidden on a per-dll level
