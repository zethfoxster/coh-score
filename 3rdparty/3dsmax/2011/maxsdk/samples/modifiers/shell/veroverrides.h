...
#define MAXVER_INTERNALNAME "Solidify\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "SolidifyPW.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Solidify Modifier\0"//should  be overidden on a per-dll level
