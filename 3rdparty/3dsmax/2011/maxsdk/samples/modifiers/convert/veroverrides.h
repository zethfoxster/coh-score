...
#define MAXVER_INTERNALNAME "Convert\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Convert.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Convert To modifiers (plugin)\0"//should  be overidden on a per-dll level
