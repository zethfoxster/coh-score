...
#define MAXVER_INTERNALNAME "SplineIKControl\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "SplineIKControl.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "A direct spline manipulator\0"//should  be overidden on a per-dll level
