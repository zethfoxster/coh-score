...
#define MAXVER_INTERNALNAME "VertexPaint\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "VertexPaint.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Vertex Color Paint (plugin)\0"//should  be overidden on a per-dll level
