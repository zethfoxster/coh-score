...
#define MAXVER_INTERNALNAME "PointCache\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "PointCache.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Disk Cache Modifier\0"//should  be overidden on a per-dll level
