...
#define MAXVER_INTERNALNAME "surfwrap\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "surfwrap.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Surface wrapping modifier (plugin)\0"//should  be overidden on a per-dll level
