...
#define MAXVER_INTERNALNAME "melt\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "melt.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Melt Modifier (core plugin)\0"//should  be overidden on a per-dll level
