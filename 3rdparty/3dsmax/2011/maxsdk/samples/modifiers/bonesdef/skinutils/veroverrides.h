...
#define MAXVER_INTERNALNAME "SkinUtils\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "SkinUtils.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Skin Utilities (core plugin)\0"//should  be overidden on a per-dll level
