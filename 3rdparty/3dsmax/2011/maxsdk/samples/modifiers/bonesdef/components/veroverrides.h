...
#define MAXVER_INTERNALNAME "MAXComponents\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "MAXComponents.DLL\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MAXComponents Module\0"//should  be overidden on a per-dll level
