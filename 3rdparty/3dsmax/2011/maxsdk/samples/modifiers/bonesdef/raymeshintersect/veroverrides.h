...
#define MAXVER_INTERNALNAME "RayMeshIntersect\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "RayMeshIntersect.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "rayMeshIntersect (core plugin)\0"//should  be overidden on a per-dll level
