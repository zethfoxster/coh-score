...
#define MAXVER_INTERNALNAME "bonesdef\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "bonesdef.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "BonesDef modifier (core plugin)\0"//should  be overidden on a per-dll level
