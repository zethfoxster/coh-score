...
#define MAXVER_INTERNALNAME "relax\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "relax.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Relax modifier (core plugin)\0"//should  be overidden on a per-dll level
