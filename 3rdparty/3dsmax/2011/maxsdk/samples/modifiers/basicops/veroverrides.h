...
#define MAXVER_INTERNALNAME "BasicOps\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "BasicOps.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Basic Operations (plugin)\0"//should  be overidden on a per-dll level
