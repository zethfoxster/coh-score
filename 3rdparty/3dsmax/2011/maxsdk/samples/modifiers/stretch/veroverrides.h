...
#define MAXVER_INTERNALNAME "stretch\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "stretch.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Stretch modifier (plugin)\0"//should  be overidden on a per-dll level
