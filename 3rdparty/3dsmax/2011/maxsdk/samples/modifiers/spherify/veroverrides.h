...
#define MAXVER_INTERNALNAME "spherify\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "spherify.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Spherify modifier (plugin)\0"//should  be overidden on a per-dll level
