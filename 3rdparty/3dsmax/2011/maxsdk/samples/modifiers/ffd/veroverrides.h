...
#define MAXVER_INTERNALNAME "ffdmod\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "ffdmod.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "FFD modifier (plugin)\0"//should  be overidden on a per-dll level
