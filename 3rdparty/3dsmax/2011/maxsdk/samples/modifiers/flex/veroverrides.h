...
#define MAXVER_INTERNALNAME "lag\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "lag.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Lag modifier (core plugin)\0"//should  be overidden on a per-dll level
