...
#define MAXVER_INTERNALNAME "MorpherMXS\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "MorpherMXS.dlx\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Morpher Modifier SDK Example\0"//should  be overidden on a per-dll level
