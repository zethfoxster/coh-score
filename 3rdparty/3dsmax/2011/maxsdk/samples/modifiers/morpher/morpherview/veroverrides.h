...
#define MAXVER_INTERNALNAME "MorpherView\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "MorpherView.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MorpherView Utility\0"//should  be overidden on a per-dll level
