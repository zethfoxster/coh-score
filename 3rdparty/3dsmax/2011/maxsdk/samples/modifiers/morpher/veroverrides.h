...
#define MAXVER_INTERNALNAME "morpher\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "morpher.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Morph Modifier (core plugin)\0"//should  be overidden on a per-dll level
